...
# ╔═╡ 178ea8a8-fdea-11ee-13d2-2973503eaa5b
using CairoMakie, Distributions

# ╔═╡ d7c14440-7e33-4831-af3e-5e1107429f14
n = 100

# ╔═╡ 195b6fe9-a658-48cc-8f76-73ce18d1e820
λ = 10

# ╔═╡ b8589967-b4ec-44dc-a75e-756974c2ae85
samples=rand(Poisson(λ),n)

# ╔═╡ 7a68bcef-7fe5-458f-9438-97e94fbf73a1
S = sum(samples)

# ╔═╡ c039a5e3-0fbc-4c80-a266-bf4ea816481f
avg = S / n

# ╔═╡ 8aa8dfc2-25e6-490a-a2f3-690314884c71
Alist = []

# ╔═╡ b918a9d8-6807-4269-96dd-5a3b2074fc18
with_theme() do
	avg
	fig = Figure(; size=(200,200))
	ax = Axis(fig[1,1])
	
	hist!(ax,Alist; bins=9:0.1:11)
	vlines!([λ])

	fig
end

# ╔═╡ 56ddddb1-0a91-4abe-a8c1-54d5738acbdd
push!(Alist,avg)
...
manifest_format = "2.0"
project_hash = "ab12b0f65ff39beb225eeea8ad03fe4900ed05fd"
